...
const Formulario = ({setResume, setUpload}) => {
  ...
  // Leer los datos del formularios y colocarlos en el state
  ...
  const cotizarSeguro = e => {
    ...
    const difference = obtenerDiferenciaYear(year);

    // por cada año hay que restar el 3%
    result -= ((difference * 3) * result) / 100;

    // americano 15%, asiaticot 5%, europeo 30%
